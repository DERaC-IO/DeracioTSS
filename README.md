...
Latest Version: 1.0.1 (August 22, 2023)
...
|handler (app) setup script|CLI|`1.1`|Working|
|settings managing script|CLI|`1.2`|Working|
|integrations with alembic/sqlalchemy|CLI|`1.3`|Working|
